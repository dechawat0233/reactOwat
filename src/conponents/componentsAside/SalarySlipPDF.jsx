...
function SalarySlipPDF() {
    ...
    const generatePDF = () => {
        ...
        for (let i = 0; i < responseDataAll.length; i += 2) {
            ...
            //แถวเงินเดือน
            pdf.text(`${countcal.toFixed(2)}`, 68, 48.1, { align: 'right' });
            ...
            pdf.text(`${countSpecialDayListWork.toFixed(2)}`, 68, 60.4, { align: 'right' });
            pdf.text(`${formattedAmountHoliday2_0.toFixed(2)}`, 92, 60.4, { align: 'right' });
            ...
            pdf.text(`${formattedSumAddSalaryAfterTax}`, 92, 80.9, { align: 'right' });
            //จ่ายป่วย 
            ...
            pdf.text(`${sumSalary}`, 92, 96, { align: 'right' });
            ...
            if (i + 1 < responseDataAll.length) {
                ...
                //แถวเงินเดือน
                pdf.text(`${countcal.toFixed(2)}`, 68, head2 + 23.1, { align: 'right' });
                ...
                pdf.text(`${countSpecialDayListWork.toFixed(2)}`, 68, head2 + 35.4, { align: 'right' });
                pdf.text(`${formattedAmountHoliday2_0.toFixed(2)}`, 92, head2 + 35.4, { align: 'right' });
                ...
                pdf.text(`${countSpecialDayWork.toFixed(2)}`, 68, head2 + 51.8, { align: 'right' });
                pdf.text(`${formattedAmountHoliday.toFixed(2)}`, 92, head2 + 51.8, { align: 'right' });
