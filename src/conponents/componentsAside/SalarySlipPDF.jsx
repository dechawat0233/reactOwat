...
function SalarySlipPDF({ employeeList }) {
  ...
  const generatePDF = () => {
    ...
    for (let i = 0; i < responseDataAll.length; i += 2) {
      ...
      console.log(
        "responseDataAll[i].accountingRecord[0].amountDay",
        responseDataAll[i].accountingRecord?.[0].amountDay
      );
      if (
      ...
      console.log(amountDay, amountOt, sumAddSalary, specialDayRate);
      pdf.text(
      ...
      if (i + 1 < responseDataAll.length) {
        ...
        console.log(
          ...
          responseDataAll[i + 1].accountingRecord[0].amountDay
        );
        if (
