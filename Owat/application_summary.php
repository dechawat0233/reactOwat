      ...
      <div class="container-fluid">
	   ...
	   <section class="clr">
		   ...
		   <div class="row">
				<ol>
					<li>
					    <label class="col-form-label" style="padding-right: 10px;">เกิดวันที่ 20</label>
						<label class="col-form-label" style="padding-right: 10px;">เดือนเมษายน</label>
						<label class="col-form-label">พ.ศ. 2550</label>
					</li>
					<li>
					    <label class="col-form-label" style="padding-right: 10px;">เกิดวันที่ 10</label>
						<label class="col-form-label" style="padding-right: 10px;">เดือนเมษายน</label>
						<label class="col-form-label">พ.ศ. 2550</label>
					</li>
				</ol>
