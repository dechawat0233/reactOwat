  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
       <form id="myForm" action="#">
        ...
        <section class="Frame">
		  <div class="row">
			    ...
			    <div class="">
					<div class="form-check form-check-inline" style="padding-top:5px;">
				    	<input class="form-check-input" type="checkbox" id="no1" value="">
				    	<label class="form-check-label txt-control" style="width:100%;margin-right: 10px;" for="inlineRadio2">เพื่อนหรือเจ้าหน้าที่แนะนำ</label>
						<input type="" class="form-control form-check-label" id="choose_hospital1"  placeholder="">
				    </div>
			     </div>
		       <div class="">
					<div class="form-check form-check-inline" style="padding-top:5px;">
		   ...
		   <div class="row">
			    <div class="">
					<div class="form-check form-check-inline" style="padding-top:5px;">
				    	...
				    	<label class="form-check-label txt-control" style="width:100%;margin-right: 10px;" for="inlineRadio2">ไม่มีประกันสังคม</label>
	   ...
	   <div class="line_btn">
			<button type="submit" formaction="application1.php" class="btn b-next"> ต่อไป &nbsp; <i class="fas fa-angle-right"></i></button>
	   </div>
       </form>
      </div><!-- /.container-fluid -->
    </section><!-- /.content -->
