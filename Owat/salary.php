					...
					<form action="">
						...
						<section class="Frame">
							<div class="col-md-12">
								...
								<div class="row">
									<h2 class="title">สถานที่ปฎิบัติงานประจำ</h2>
								</div>
								<div class="row">
									<div class="col-md-4">
										<div class="form-group">
						...
						<section class="Frame">
							...
							<div class="form-group row">
								...
								<div class="col-sm-9">
									<div class="icheck-primary d-inline">
										<input type="radio" id="radioPrimary1" name="r1" checked=""> เดือน
									</div>
									<div class="icheck-primary d-inline">
										<input type="radio" id="radioPrimary2" name="r1"> ครึ่งเดือน
									</div>
									<div class="icheck-primary d-inline">
										<input type="radio" id="radioPrimary1" name="r1" checked=""> สัปดาห์
									</div>
									<div class="icheck-primary d-inline">
										<input type="radio" id="radioPrimary2" name="r1"> งวดพิเศษ
									</div>
									<div class="icheck-primary d-inline">
										<input type="radio" id="radioPrimary2" name="r1"> 10 วัน
									</div>
								</div>
							</div><!--row-->
							<div class="form-group row">
								...
								<div class="col-sm-9">
									<div class="icheck-primary d-inline">
										<input type="radio" id="radioPrimary1" name="r1" checked=""> เงินสด
									</div>
									<div class="icheck-primary d-inline">
										<input type="radio" id="radioPrimary2" name="r1"> โอนผ่านธนาคาร
									</div>
								</div>
							</div><!--row-->
							<div class="row">
