...
const workplaceTimerecordoutsideSchema = new mongoose.Schema({
  timerecordId: String,
  workplaceId: String,
...
const workplaceTimerecord = mongoose.model('workplaceTimerecordoutside', workplaceTimerecordoutsideSchema);

// Define time record schema for employee
const employeeTimerecordoutsideSchema = new mongoose.Schema({
  timerecordId: String,
  employeeId: String,
  employeeName: String,
  month: String,
...
// Create the workplace record time model based on the schema
const workplaceTimerecordEmp = mongoose.model('employeeTimerecordoutside', employeeTimerecordoutsideSchema );
