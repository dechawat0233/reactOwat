...
if(wGroup1 && Object.keys(wGroup1).length > 2) {
  console.log('wGroup1 X ' + JSON.stringify(wGroup1    ,2,null))
  // console.log('wGroup X ' + Object.keys(wGroup).length )

if(Object.keys(wGroup1).length > 1) {

  for (const workplaceId of Object.keys(wGroup1)) {
    const group1 = wGroup1[workplaceId];
    // console.log(`Workplace ID: ${group1.workplaceId}, Workplace Name: ${group1.workplaceName}`);
